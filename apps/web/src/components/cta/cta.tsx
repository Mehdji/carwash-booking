...
const cta = ()=>{
    return(
      ...
      <h1 id="cta" className="text-5xl font-bold font-display  text-white text-center">
      ...
      <Link
        to="/login"
        className="mt-10 inline-block cursor-pointer bg-blue-text hover:bg-blue-700 text-white shadow-[0_0_70px_rgba(0,159,227)] hover:shadow-[0_0_40px_rgba(0,159,227)] font-display text-1xl py-2 px-4 rounded transition-all hover:scale-125"
       >
